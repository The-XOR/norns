...
#define lua_register_norns(lvm, n, f) (lua_pushcfunction(lvm, f), lua_setfield(lvm, -2, n))

//=========================================================================================
// Register lua
void dev_push2_register(lua_State *lvm) {

    lua_register_norns(lvm, "p2_update", &_push2d_update);
    lua_register_norns(lvm, "p2_save", &_push2d_save);
    lua_register_norns(lvm, "p2_restore", &_push2d_restore);
    lua_register_norns(lvm, "p2_font_face", &_push2d_font_face);
    lua_register_norns(lvm, "p2_font_size", &_push2d_font_size);
    lua_register_norns(lvm, "p2_aa", &_push2d_aa);
    lua_register_norns(lvm, "p2_line_cap", &_push2d_line_cap);
    lua_register_norns(lvm, "p2_line_join", &_push2d_line_join);
    lua_register_norns(lvm, "p2_miter_limit", &_push2d_miter_limit);
    lua_register_norns(lvm, "p2_colour", &_push2d_colour);
    lua_register_norns(lvm, "p2_line_width", &_push2d_line_width);
    lua_register_norns(lvm, "p2_move", &_push2d_move);
    lua_register_norns(lvm, "p2_line", &_push2d_line);
    lua_register_norns(lvm, "p2_move_rel", &_push2d_move_rel);
    lua_register_norns(lvm, "p2_line_rel", &_push2d_line_rel);
    lua_register_norns(lvm, "p2_curve", &_push2d_curve);
    lua_register_norns(lvm, "p2_curve_rel", &_push2d_curve_rel);
    lua_register_norns(lvm, "p2_arc", &_push2d_arc);
    lua_register_norns(lvm, "p2_rect", &_push2d_rect);
    lua_register_norns(lvm, "p2_stroke", &_push2d_stroke);
    lua_register_norns(lvm, "p2_fill", &_push2d_fill);
    lua_register_norns(lvm, "p2_text", &_push2d_text);
    lua_register_norns(lvm, "p2_clear", &_push2d_clear);
    lua_register_norns(lvm, "p2_close", &_push2d_close);
    lua_register_norns(lvm, "p2_extents", &_push2d_extents);

    // set buttons state
    lua_register_norns(lvm, "p2_button_state", &_push2d_button_state);
}

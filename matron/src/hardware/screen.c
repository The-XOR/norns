...
#define COLOR_OFF 0,0,0,0,0

#define DIMMED_COLORS 0.46666666666667,  \
                      0.53333333333333,  \
                      0.6, \
                      0.66666666666667, \
                      0.73333333333333

#define HIGHTLIGH_COLOR 0.73333333333333, \
                        0.8, \
                        0.86666666666667, \
                        0.93333333333333, \
                        1

static float c[16] = {0,   0.236666666666667, 0.30333333333333, 0.6, 0.30666666666667, 0.50333333333333,
...
void screen_init(void) {
    ...
    if(MAGNIFY_WIDTH >1 || MAGNIFY_HEIGHT>1)
